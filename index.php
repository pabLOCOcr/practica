...
<html>
	...
	<body>
		<div class="center">
			esta es la linea que hace pabLOCO
			y esta es la linea que hace jruiz en arweb
			<p>
			...
			<h1>Este titulo va a ir en el primer commit pero en Github</h1>
			...
			<br>
			<br>
			<div class="center">Test es otro div</div><!--end .center -->
			<hr>
			<br>
			<div class="center">Test es otro div</div><!--end .center -->
			<hr>
			...
			<span>
				...
				<span>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eu sapien iaculis, aliquet sapien vitae, sollicitudin augue. Phasellus ipsum enim, dapibus vitae sapien vitae, facilisis vestibulum nisi. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Pellentesque tristique fermentum leo, vel convallis est condimentum in. Nullam ultrices ipsum quis arcu dictum lobortis. Vivamus non tempus neque. Integer blandit leo nisi, a lobortis lectus aliquam ac. Praesent venenatis fringilla arcu, id lacinia erat tristique ut. Donec at mauris eu est placerat efficitur. Curabitur vitae pellentesque neque. Sed lacinia tempus consectetur. Donec mattis vestibulum urna vitae bibendum.

					Integer vehicula malesuada scelerisque. Etiam pharetra massa sed tortor suscipit posuere a non enim. Aenean sed elit vitae augue eleifend pellentesque. Mauris congue leo vitae odio eleifend, ut porttitor orci sagittis. Praesent eget leo ac odio tincidunt faucibus. Nam viverra lorem vel purus tincidunt egestas eget id diam. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nullam elit odio, malesuada vitae massa et, ultricies vehicula arcu. Phasellus dictum massa sed dui vestibulum, at laoreet diam blandit. Etiam porta, libero sed mollis vehicula, dui velit facilisis purus, non imperdiet libero enim ut urna. Aliquam et porta sem, eu venenatis diam.
				</span>
